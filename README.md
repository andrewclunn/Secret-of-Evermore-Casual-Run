...
`Casual_Run_Patch.ips` is an ips patch for the American *Secret of Evermore* ROM.   It includes both FuSOYa's two player patch and Ninakoru's gameplay balance patches.
